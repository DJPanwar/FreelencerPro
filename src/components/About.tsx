        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              I'm a passionate freelancer with a mission to transform creative
              visions into digital realities. With over 1 years of experience in
              web development, design, and digital marketing, I've helped
              businesses of all sizes establish their online presence and
              achieve their goals.
            </p>
            ...
            <p className="text-gray-300 mb-8 leading-relaxed">
              ...
              but also delivers results. I believe in collaborative partnerships
              with my clients, transparent communication, and exceptional
