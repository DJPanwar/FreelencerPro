...
import { FormErrors, FormData } from "../types/type";
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            ...
            business? Reach out to me using any of the methods below.
          </p>
        </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6 transition-transform duration-300 hover:-translate-y-1">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:hello@freelancepro.com"
                      className="text-emerald-400 hover:text-emerald-300 transition-colors duration-300 inline-block mt-2"
                    >
                      Send an email
                    </a>
                  </div>
              ...
              <form onSubmit={onSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <div
                      className={`relative ${errors.name ? "mb-8" : "mb-0"}`}
                    >
                      <input
                        type="text"
                        id="name"
                  ...
                  <div>
                    ...
                    <div
                      className={`relative ${errors.email ? "mb-8" : "mb-0"}`}
                    >
                      <input
                        type="email"
                        id="email"
                ...
                <div className="mb-6">
                  ...
                  <div
                    className={`relative ${errors.subject ? "mb-8" : "mb-0"}`}
                  >
                    <input
                      type="text"
                      id="subject"
                ...
                <div className="mb-6">
                  ...
                  <div
                    className={`relative ${errors.message ? "mb-8" : "mb-0"}`}
                  >
                    <textarea
                      id="message"
                      name="message"
