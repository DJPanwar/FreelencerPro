...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center overflow-hidden"
    >
      {/* Spline Animation Background */}
      <div className="absolute inset-0 w-full h-full z-0">
        <Spline scene="/assets/scene.splinecode" className="w-full h-full" />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 py-24 relative z-10">
        <div className="max-w-3xl mx-auto text-center md:mx-0 md:text-left">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Turning Your <span className="text-emerald-500">Vision</span> Into
            Digital <span className="text-emerald-500">Reality</span>
          </h1>

          <p className="text-gray-300 text-lg md:text-xl mb-8 leading-relaxed">
            Expert freelance services delivering exceptional results that exceed
            expectations. Specializing in web development, design, and digital
            marketing solutions.
          </p>
